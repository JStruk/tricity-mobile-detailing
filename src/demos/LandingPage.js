...
export default () => (
  <AnimationRevealPage>
      ...
      <MainFeature
          ...
          description={
              <Description>
                  Choose between our Bronze, Silver, and Gold interior detail packages. Treat yourself and your vehicle
      ...
      <MainFeature
          ...
          description={
              <Description>
                  Restore your vehicles look to showroom quality with our professional exterior detailing service. We
